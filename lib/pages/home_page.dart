...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  // breathe animation for start button
  ...
  // unified glow text style (soft subtle neon glow per your final choice)
  TextStyle glowTextStyle({double size = 14, FontWeight weight = FontWeight.w500, Color color = Colors.white}) {
    return TextStyle(
      color: color,
      fontSize: size,
      fontWeight: weight,
      shadows: [
        // Subtle neon glow — not overpowering
        Shadow(blurRadius: 8, color: Colors.white.withOpacity(0.20)),
        Shadow(blurRadius: 14, color: Colors.white.withOpacity(0.08)),
      ],
    );
  }
          ...
          child: _glassCard(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Expanded(child: Text('Leaderboard — ${selectedLevel.toUpperCase()}', style: glowTextStyle(size: 18, weight: FontWeight.w800))),
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: Text(entry['users']?['username'] ?? 'Unknown', style: glowTextStyle(size: 15, weight: FontWeight.w600))),
                            Text(displayTime, style: glowTextStyle(size: 15, weight: FontWeight.w800)),
                          ],
                        ),
                      );
                    },
                        ...
                        child: _glassCard(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 12),
                              Expanded(child: Text('Hello, $username', style: glowTextStyle(size: 18, weight: FontWeight.w800))),
                              Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text('$coins', style: glowTextStyle(size: 14, weight: FontWeight.w800)),
                                    ],
                                  ),
                                  ...
                                  InkWell(
                                    ...
                                    child: Text('Sign out', style: glowTextStyle(size: 12, weight: FontWeight.w600).copyWith(color: Colors.white70)),
                                  ),
                                ],
                              ),
                            ],
                      ...
                      children: [
                        ...
                        LayoutBuilder(builder: (context, constraints) {
                          return AnimatedSwitcher(
                            ...
                            child: SizedBox(key: ValueKey('play-$selectedLevel'), child: playTab(constraints)),
                          );
                        }),
                        // Leaderboard (page 1)
                        AnimatedSwitcher(duration: const Duration(milliseconds: 420), child: Container(key: const ValueKey('leaderboard'), child: leaderboardTab())),
                        // Shop (page 2)
                        AnimatedSwitcher(duration: const Duration(milliseconds: 420), child: Container(key: const ValueKey('shop'), child: shopTab())),
                      ],
                    ),
                  ),
            ...
            child: Center(
              child: _FloatingGlassNav(
                ...
                onTap: (idx) {
                  _onNavTap(idx);
                  // also jump page view
                  _pageController.animateToPage(idx, duration: const Duration(milliseconds: 520), curve: Curves.easeInOut);
                },
              ),
            ),
          ),
